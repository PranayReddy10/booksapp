...
public class BookDetailList implements Serializable {
    ...
    @SerializedName("continue_page_num")
    private String continue_page_num;
    ...
    public String getContinue_page_num() {
        return continue_page_num;
    }

    public void setContinue_page_num(String continue_page_num) {
        this.continue_page_num = continue_page_num;
    }
}
