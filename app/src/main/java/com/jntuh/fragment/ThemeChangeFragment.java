...
import com.jntuh.books.databinding.LayoutThemeBinding;
...
public class ThemeChangeFragment extends BottomSheetDialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        viewThemeBinding.btnMaybeLater.setOnClickListener(v -> dismiss());

        viewThemeBinding.btnSubmit.setOnClickListener(v -> {
