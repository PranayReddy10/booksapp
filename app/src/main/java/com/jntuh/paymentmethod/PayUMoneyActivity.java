...
public class PayUMoneyActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        payUMoneyBinding.toolbarMain.imageArrowBack.setOnClickListener(v -> getOnBackPressedDispatcher().onBackPressed());
        ...
        payUMoneyBinding.btnPay.setOnClickListener(view -> {
            if (method.getUserPhone().isEmpty()) {
                showErrorPhone();
            } else {
                startPayment();
