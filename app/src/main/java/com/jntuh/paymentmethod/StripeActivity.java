...
import com.jntuh.books.databinding.ActivityStripePaymentBinding;
...
public class StripeActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        stripePaymentBinding.toolbarMain.imageArrowBack.setOnClickListener(v -> getOnBackPressedDispatcher().onBackPressed());
        ...
        paymentSheet = new PaymentSheet((ComponentActivity) StripeActivity.this, paymentSheetResult -> onPaymentSheetResult1(paymentSheetResult));


        stripePaymentBinding.btnPay.setOnClickListener(view -> {
