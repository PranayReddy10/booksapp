...
import com.jntuh.adapter.PlanAdapter;
import com.jntuh.books.databinding.ActivityPlanBinding;
import com.jntuh.paymentmethod.Transaction;
...
public class PlanListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityPlanBinding.ivClose.setOnClickListener(v -> getOnBackPressedDispatcher().onBackPressed());
                ...
                try {
                    ...
                    if (planRP !=null && planRP.getSuccess().equals("1")) {
                        if (planRP.getItemPlanLists().size() != 0) {
                            ...
                            activityPlanBinding.btnPlan.setOnClickListener(v -> {
