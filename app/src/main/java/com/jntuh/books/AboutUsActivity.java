...
import com.jntuh.books.databinding.ActivityAboutUsBinding;
...
public class AboutUsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewAboutUs.toolbarMain.imageArrowBack.setOnClickListener(v -> getOnBackPressedDispatcher().onBackPressed());
        ...
        viewAboutUs.ivFb.setOnClickListener(v -> {
        ...
        viewAboutUs.ivInsta.setOnClickListener(v -> {
        ...
        viewAboutUs.ivYt.setOnClickListener(v -> {
        ...
        viewAboutUs.ivWeb.setOnClickListener(v -> {
