...
import com.jntuh.books.databinding.ActivitySplashBinding;
...
public class SplashActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (method.isNetworkAvailable()) {
            ...
            intentMain.putExtra("isDown", "isOff");
    ...
    private void initializeAds() {
        switch (Constant.adNetworkType) {
            case "Unity Ads":
                ...
                break;
            case "AppLovins MAX":
                AppLovinSdkInitializationConfiguration initConfig = AppLovinSdkInitializationConfiguration.builder(getString(R.string.applovin_sdk_key), this).setMediationProvider(AppLovinMediationProvider.MAX).build();
            ...
            case "StartApp":
                ...
                break;
            case "Wortise":
                WortiseSdk.initialize(this, Constant.adsInfo.getPublisherId(), () -> {
