    ...
    public void onBindViewHolder(@NotNull RecyclerView.ViewHolder holder, final int position) {
        if (holder.getItemViewType() == VIEW_TYPE_ITEM) {
            ...
            if (subCatListBook.getBook_on_rent().equals("1")) {
                ...
                viewHolder.rowBookListBinding.tvPremium.setText(activity.getString(R.string.rent));
                viewHolder.rowBookListBinding.imageLock.setImageResource(R.drawable.ic_rent);
                ...
                viewHolder.rowBookListBinding.tvBookPrice.setBackgroundResource(R.drawable.paid_detail_box);
                viewHolder.rowBookListBinding.tvBookPrice.setTextColor(ContextCompat.getColor(activity, R.color.white));
            } else if (subCatListBook.getPost_access().equals("Paid")) {
                viewHolder.rowBookListBinding.llPremium.setVisibility(View.VISIBLE);
                viewHolder.rowBookListBinding.tvPremium.setText(activity.getString(R.string.lbl_premium));
                viewHolder.rowBookListBinding.imageLock.setImageResource(R.drawable.img_premium_lock);
                ...
                viewHolder.rowBookListBinding.tvBookPrice.setBackgroundResource(R.drawable.free_box);
            ...
            viewHolder.rowBookListBinding.ivPlayBadge.setVisibility(subCatListBook.isVideo() ? View.VISIBLE : View.GONE);
