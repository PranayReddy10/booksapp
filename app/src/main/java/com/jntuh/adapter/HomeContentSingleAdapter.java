...
import com.jntuh.books.databinding.RowAuthorBinding;
import com.jntuh.books.databinding.RowBookGridBinding;
import com.jntuh.books.databinding.RowCatBinding;
    ...
    public void onBindViewHolder(@NotNull RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder.getItemViewType() == VIEW_TYPE_CAT) {
            ...
            if (homeContentPos.getBook_on_rent().equals("1")) {
                ...
                bookHolder.rowTrendHomeBinding.tvBookPrice.setBackgroundResource(R.drawable.paid_detail_box);
                bookHolder.rowTrendHomeBinding.tvBookPrice.setTextColor(ContextCompat.getColor(activity, R.color.white));
                ...
                bookHolder.rowTrendHomeBinding.tvBookPrice.setBackgroundResource(R.drawable.free_box);
                bookHolder.rowTrendHomeBinding.tvBookPrice.setTextColor(ContextCompat.getColor(activity, R.color.free_box_text));
            }
            bookHolder.rowTrendHomeBinding.tvBookName.setText(homeContentPos.getPostTitle());
